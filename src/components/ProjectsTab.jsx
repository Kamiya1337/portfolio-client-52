    ...
    return (
      <div className="max-w-4xl mx-auto animate-fade-in pb-10 relative">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
          ...
          <div className="bg-gradient-to-br from-academic-navy via-slate-800 to-academic-hero-blue p-8 text-white relative overflow-hidden">
            ...
            <div className="relative z-10">
              <span className="px-3 py-1 bg-blue-500/30 text-blue-100 text-xs font-bold rounded uppercase tracking-wider mb-4 inline-block backdrop-blur-sm border border-blue-300/30">
        ...
        {projects.map((project) => (
          <div key={project.id} className="bg-white rounded-2xl shadow-sm border border-slate-200 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col overflow-hidden">
            ...
            <button 
              ...
              className="w-full py-4 bg-slate-50 text-academic-blue font-semibold border-t border-slate-100 hover:bg-academic-blue hover:text-white transition-colors flex justify-center items-center gap-2 group"
            >
