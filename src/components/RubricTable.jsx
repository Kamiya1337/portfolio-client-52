    ...
    <div className="max-w-6xl mx-auto animate-fade-in pb-10 font-sans">
      ...
      <div className="bg-white p-6 rounded-2xl shadow-sm border border-academic-border mb-8">
        ...
        <div className="w-full bg-slate-100 rounded-full h-3.5 overflow-hidden border border-slate-200/50">
          <div 
            className="bg-gradient-to-r from-academic-blue to-academic-cyan h-full rounded-full transition-all duration-700 ease-out" 
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-academic-border overflow-hidden">
        <div className="overflow-x-auto">
          <table className="w-full text-left border-collapse min-w-[800px]">
            <thead>
              <tr className="bg-academic-navy text-white text-sm">
